...
np.random.seed(42)
landmark_idx = np.random.choice(len(X), 3000, replace=False)
...
P_explicit = lil_matrix((3000, 3000), dtype=np.float32)
...
P_analytical = lil_matrix((3000, 3000), dtype=np.float32)
