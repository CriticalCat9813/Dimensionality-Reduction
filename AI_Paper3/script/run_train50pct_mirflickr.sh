python main.py --data_dir data/mirflickr/mirflickr_data.npy --train_50pct_idx data/mirflickr/mirflickr_train_50pct_idx.npy --valid_idx data/mirflickr/mirflickr_val_idx.npy --test_idx data/mirflickr/mirflickr_test_idx.npy --learning_rate 0.002 \
